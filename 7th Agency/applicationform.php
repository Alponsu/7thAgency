...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        // Insert data into work_experience
        $stmt = $conn->prepare("INSERT INTO work_experience (employer, employerContact, employerAddress, dateEmployed, employedPosition, reasonforLeaving, applicantID) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssi", $work_name, $work_contact, $work_address, $work_date_available, $work_position, $work_reason_leaving, $applicantID);
        $stmt->execute();
            ...
            <section class="work-experience">
                ...
                <div class="container">
                    <div class="az-div">
                        ...
                        <div class="form-group">
                            <label for="work-contact">CONTACT NUMBER</label>
                            <input type="text" id="work-contact" name="work-contact" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="az-div">
                        <div class="form-group">
                            <label for="work-date-employed">DATE EMPLOYED</label>
                            <input type="date" id="work-date-employed" name="work-date-employed" required>
                        </div>
                        <div class="form-group">
                            <label for="work-position">POSITION</label>
                            <input type="text" id="work-position" name="work-position" required>
                        </div>
                        <div class="form-group">
                            <label for="work-reason-leaving">REASON FOR LEAVING</label>
                            <input type="text" id="work-reason-leaving" name="work-reason-leaving" required>
                        </div>
                    </div>
                </div>
            </section> 
